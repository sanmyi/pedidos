...
public class poducto {
	 @Id
	    ...
	    public poducto(String nombre, String codigo, Float precio, Float existencia, long id) {
	        this.nombre = nombre;
	        this.codigo = codigo;
	        this.precio = precio;
	    ...
	    public poducto(String nombre, String codigo, Float precio, Float existencia) {
	        this.nombre = nombre;
	        this.codigo = codigo;
	        this.precio = precio;
	        this.existencia = existencia;
	    ...
	    public poducto(@NotNull(message = "Debes especificar el código") @Size(min = 1, max = 50, message = "El código debe medir entre 1 y 50") String codigo) {
	        this.codigo = codigo;
	    }
